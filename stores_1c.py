...
"""Script generates report about stores and schedule transferred from
1C to Ecom. Whith that data user can check if Ecom got correct data.

Filtering by store is optional - you can filter by oranization instead.

Example of usage:
    ./stores_1c.py -d 2022-11-26T12:00:00.000Z -m mailru -o спб
"""
