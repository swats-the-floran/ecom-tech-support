...
"""Script generates report about stocks transferred from Ecom to a marketplace
in chronological order. Whith that data user can check if Ecom sent it correctly.
...
Example of usage:
    ./stocks_mp.py -d 2022-11-26T12:00:00.000Z -m mailru -o спб -p 12345
"""
...
if __name__ == '__main__':
    ...
    with (get_ssh_tunnel() as ssh_tunnel,
        ...
        fields_list = [field.name for field in fields(parser.dt_stock_mp)]
